            ...
            <div class="col-md-3 col-sm-12">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item float-right" href="<?php echo base_url().'index.php/login/logout';?>">Logout</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <ul class="nav flex-column ml-5 text-secondary">
                            <li class="nav-item p-2"><a href="<?php echo base_url();?>index.php/home" class="nav-link">Agenda Surat Masuk</a> </li>
                            ...
                            <li class="nav-item p-2"><a href="<?php echo base_url()?>index.php/home/manajemen" class="nav-link text-secondary">Disposisi Surat</a></li>
                            <!-- <li class="nav-item p-2"><a href="#!" class="nav-link text-secondary">Manajemen User</a></li> -->
                        </ul>
                    </div>
